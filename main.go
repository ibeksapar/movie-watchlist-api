...
func main() {
	...
	protected.HandleFunc("/movies", handlers.GetMovies).Methods("GET")
	protected.HandleFunc("/movies/{id}", handlers.GetMovieByID).Methods("GET")
	...
	protected.HandleFunc("/genres", handlers.GetGenres).Methods("GET")
	protected.HandleFunc("/genres/{id}", handlers.GetGenreByID).Methods("GET")
	...
	protected.HandleFunc("/reviews", handlers.GetReviews).Methods("GET")
	protected.HandleFunc("/reviews/{id}", handlers.GetReviewByID).Methods("GET")
